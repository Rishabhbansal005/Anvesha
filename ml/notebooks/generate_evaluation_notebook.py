"""
Script to generate `ml/notebooks/03_comprehensive_evaluation_colab.ipynb`
Contains all 12 essential evaluation graphs for Google Colab:
1. Class Distribution
2. Correlation Heatmap (Top Linguistic Features)
3. Learning Curve (Training vs Validation Accuracy across Sample Sizes)
4. Confusion Matrix Heatmap
5. Receiver Operating Characteristic (ROC-AUC) Curve
6. Precision-Recall (PR) Curve
7. Precision / Recall / F1 vs Decision Threshold Curve
8. Feature Importance (TF-IDF Log-Odds Coefficients)
9. SHAP Summary / Beeswarm Feature Attribution Plot
10. Error & Misclassification Margin Analysis
11. Probability Calibration Curve (Reliability Diagram & Brier Score)
12. Multi-Model Comparison (Logistic Regression vs Naive Bayes vs Linear SVM vs Random Forest)
"""
import json
...
def create_notebook():
    ...
    # Cell 5: GRAPH 1 - Class Distribution
    cells.append({
        "cell_type": "code",
        "metadata": {},
        "execution_count": None,
    ...
    # Cell 6: GRAPH 2 - Correlation Heatmap
    cells.append({
        "cell_type": "code",
        "metadata": {},
        "execution_count": None,
    ...
    # Cell 8: GRAPH 4 - Confusion Matrix
    cells.append({
        "cell_type": "code",
        "metadata": {},
        "execution_count": None,
    ...
    # Cell 9: GRAPH 5 & 6 - ROC-AUC & Precision-Recall
    cells.append({
        "cell_type": "code",
        "metadata": {},
        "execution_count": None,
    ...
    # Cell 10: GRAPH 7 - Precision / Recall / F1 vs Decision Threshold
    cells.append({
        "cell_type": "code",
        "metadata": {},
        "execution_count": None,
    ...
    # Cell 11: GRAPH 8 - Feature Importance
    cells.append({
        "cell_type": "code",
        "metadata": {},
        "execution_count": None,
    ...
    # Cell 12: GRAPH 9 - SHAP Summary / Beeswarm
    cells.append({
        "cell_type": "code",
        "metadata": {},
        "execution_count": None,
    ...
    # Cell 13: GRAPH 10 - Error / Margin Analysis
    cells.append({
        "cell_type": "code",
        "metadata": {},
        "execution_count": None,
    ...
    # Cell 14: GRAPH 11 - Calibration Curve
    cells.append({
        "cell_type": "code",
        "metadata": {},
        "execution_count": None,
    ...
    # Cell 15: GRAPH 12 - Multi-Model Benchmark Comparison
    cells.append({
        "cell_type": "code",
        "metadata": {},
        "execution_count": None,
    ...
    output_path = Path("ml/notebooks/03_comprehensive_evaluation_colab.ipynb")
    output_path.parent.mkdir(parents=True, exist_ok=True)
    with open(output_path, "w", encoding="utf-8") as f:
        json.dump(notebook, f, indent=1)
    print(f"Successfully generated notebook: {output_path.resolve()}")
